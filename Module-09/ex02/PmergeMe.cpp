...
std::vector< std::vector<int> > PmergeMe::groupVector(const std::vector<int> &other, unsigned int groupsize) {
...
void PmergeMe::pairAndSortGroups(std::vector< std::vector<int> > &temp, unsigned int groupsize) {
...
void PmergeMe::labelSubGroups(std::vector<std::vector<int> > &temp, std::vector<SubGroup> &mainchain, std::vector<SubGroup> &pendchain)
{
     if (temp.size() < 2)
        return;
...
void PmergeMe::insertFromPendChain(std::vector<SubGroup>& mainchain, std::vector<SubGroup>& pendchain) {
...
void PmergeMe::fordJohnsonSort(unsigned int iteration)
{
